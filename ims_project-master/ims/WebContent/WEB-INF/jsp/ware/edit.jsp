...
<body>
   ...
   <div class="wrapper">
      ...
      <div id="content">
         ...
         <br> <label for="sel1"><h4> [발주 예약 정보] </h4></label> <br> <label
            for="sel1"> 발주 번호 </label>
         <div class="col-sm-20">
         	<input type="text" class="form-control" id="inputcode"
					placeholder="wareNo">
            <c:out value="${ware.wareNo}" />
         </div>
         <br> <label for="sel1"> 제품 코드 </label>
         <div class="col-sm-20">
         	<input type="text" class="form-control" id="inputcode"
					placeholder="itemNo">
            <c:out value="${ware.itemNo}" />
         </div>
         <br> <label for="sel1"> 발주 예정일 </label>
         <div class="col-sm-20">
         	<input type="date" name="from" />
            <c:out value="${ware.wareDate}" />
         </div>
         <br> <label for="sel1"> 입고 단위 </label>
         <div class="col-sm-20">
         	<input type="text" class="form-control" id="inputcode"
					placeholder="unit">
            <c:out value="${ware.unit}" />
         </div>
         <br> <label for="sel1"> 매입단가 </label>
         <div class="col-sm-20">
         	<input type="text" class="form-control" id="inputcode"
					placeholder="price">
            <c:out value="${ware.price}" />
         </div>
         ...
         <br><br> <label for="sel1"><h4> [출금정보] </h4></label> <br> <label
            for="sel1"> 거래처 </label>
         <div class="col-sm-20">
            <!-- 버튼 -->
